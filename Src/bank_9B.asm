       ...
       UNREACH_9B823C:
          ...
          CODE_9B869B:
                       ...
                       LDY.B zpCurntTeamLoopVal             ;9B869F|A491    |;
                       LDA.W $1796,Y                        ;9B86A1|B99617  |;
                       INC A                                ;9B86A4|1A      |;
                       STA.B $A5                            ;9B86A5|85A5    |;
                       STA.W EdLnSelLineIndx                ;9B86A7|8D430D  |;
                       STZ.W $0D47                          ;9B86AA|9C470D  |;
                       LDX.B zpCurntTeamLoopVal             ;9B86AD|A691    |;
                       ...
                       STA.W EdLnAvlPlayersCount            ;9B86C8|8D9F1D  |;
                       DEC A                                ;9B86CB|3A      |;
                       STA.W EdLnCurPositionIndex           ;9B86CC|8D8B1D  |;
          ...
          CODE_9B8725:
                       ...
                       LDA.W EdLnSelLineIndx                ;9B874A|AD430D  |;
          ...
          CODE_9B87B2:
                       ...
                       CLC                                  ;9B87B4|18      |;
                       ADC.W EdLnCurPositionIndex           ;9B87B5|6D8B1D  |;
                       BMI CODE_9B880D                      ;9B87B8|3053    |;
                       CMP.W EdLnAvlPlayersCount            ;9B87BA|CD9F1D  |;
                       BPL CODE_9B880D                      ;9B87BD|104E    |;
                       STA.W EdLnCurPositionIndex           ;9B87BF|8D8B1D  |;
       ...
       UNREACH_9B87C9:
          ...
          CODE_9B8810:
                       ...
                       LDA.W EdLnSelLineIndx                ;9B882A|AD430D  |;
          ...
          CODE_9B8979:
                       ...
                       LDA.B zpCurntTeamLoopVal             ;9B89B0|A591    |;
          ...
          CODE_9B8B60:
                       ...
                       LDA.W EdLnSelLineIndx                ;9B8BC5|AD430D  |;
                       DEC A                                ;9B8BC8|3A      |;
                       ...
                       JSL.L fn_rtnEdtLinesStartIndx        ;9B8BD2|2220939B|;
                       SEC                                  ;9B8BD6|38      |;
                       ...
                       LDA.W EdLnSelLineIndx                ;9B8BEA|AD430D  |;
                       SEC                                  ;9B8BED|38      |;
          ...
          CODE_9B8BFD:
                       ...
                       CMP.W EdLnCurPositionIndex           ;9B8C05|CD8B1D  |;
          ...
          CODE_9B8C7A:
                       STA.W EdLnSelPlyIndx                 ;9B8C7A|8D8F1D  |; Store the Selected Player Index
                       LDA.W EdLnSelLineIndx                ;9B8C7D|AD430D  |; Load The Line Your Editing
                       DEC A                                ;9B8C80|3A      |; Subtract 1
                       ASL A                                ;9B8C81|0A      |; Multiple by 2
                       ASL A                                ;9B8C82|0A      |; Multiple by 2
                       ASL A                                ;9B8C83|0A      |; Multiple by 2
                       STA.B $A5                            ;9B8C84|85A5    |; Starting Index of Current Line Offset
                       JSL.L fn_rtnEdtLinesStartIndx        ;9B8C86|2220939B|;
                       SEC                                  ;9B8C8A|38      |; Set Carry Flag
                       ADC.B $A5                            ;9B8C8B|65A5    |; Add the Starting Index Offset of the Line being editing
                       STA.B $A5                            ;9B8C8D|85A5    |; Store the reult back to $A5. This is now contains the RAM address of the line being editied
                       LDA.W EdLnAvlPlayersCount            ;9B8C8F|AD9F1D  |; 4 if pk; 5 if Line 1-3 or PP
                       SEC                                  ;9B8C92|38      |; Set The Carry Flag
                       SBC.W EdLnCurPositionIndex           ;9B8C93|ED8B1D  |; Restul of SBC 1=LD 2=RD 3=LW 4=C 5=RW
                       JSR.W ExtAttackerFix                 ;9B8C96|2078CE  |; Left Defense; ExtAttackerFix Hijack
                       BEQ CODE_9B8D0E                      ;9B8C99|F073    |; Branch if Left Defense
                       CMP.W #$0002                         ;9B8C9B|C90200  |; Right Defense
                       BEQ CODE_9B8CFD                      ;9B8C9E|F05D    |; Branch to Right Defense
                       CMP.W #$0003                         ;9B8CA0|C90300  |; Left Wing
                       BEQ CODE_9B8CE1                      ;9B8CA3|F03C    |; Branch to Left Wing
                       CMP.W #$0004                         ;9B8CA5|C90400  |; Center
                       BEQ CODE_9B8CC4                      ;9B8CA8|F01A    |; Branch To Center
                       LDA.B $A5                            ;9B8CAA|A5A5    |; Fall Through to Right Wing
                       INC A                                ;9B8CAC|1A      |;
                       INC A                                ;9B8CAD|1A      |;
                       STA.B $95                            ;9B8CAE|8595    |;
                       JSR.W CODE_9B8D72                    ;9B8CB0|20728D  |;
                       CMP.W EdLnSelPlyIndx                 ;9B8CB3|CD8F1D  |;
                       BNE CODE_9B8CBD                      ;9B8CB6|D005    |;
                       JSR.W CODE_9B8D4D                    ;9B8CB8|204D8D  |;
                       BRA CODE_9B8D20                      ;9B8CBB|8063    |;
          ...
          CODE_9B8CC4:
                       LDA.B $A5                            ;9B8CC4|A5A5    |; Load Starting Index of Current Line Being Edited
                       CLC                                  ;9B8CC6|18      |; Clear the Carry Flag
                       ADC.W #$0004                         ;9B8CC7|690400  |; Add 4 to get the ram address of the right winger
                       STA.B $95                            ;9B8CCA|8595    |; Store the right wings ram address in ZP $95
                       JSR.W CODE_9B8D72                    ;9B8CCC|20728D  |; Returns Player Index from right wing
                       CMP.W EdLnSelPlyIndx                 ;9B8CCF|CD8F1D  |; Compares to see if your swapping Center with Right Wing
                       BNE CODE_9B8CDB                      ;9B8CD2|D007    |; Not Swapping so branch
                       DEC.B $95                            ;9B8CD4|C695    |; Decrease back to centers ram value
                       JSR.W CODE_9B8D32                    ;9B8CD6|20328D  |; Return ?
                       BRA CODE_9B8D20                      ;9B8CD9|8045    |;
          ...
          CODE_9B8CE1:
                       ...
                       CMP.W EdLnSelPlyIndx                 ;9B8CEC|CD8F1D  |;
                       BNE CODE_9B8CF6                      ;9B8CEF|D005    |;
                       JSR.W CODE_9B8D4D                    ;9B8CF1|204D8D  |;
                       BRA CODE_9B8D20                      ;9B8CF4|802A    |;
          ...
          CODE_9B8CFF:
                       ...
                       CMP.W EdLnSelPlyIndx                 ;9B8D04|CD8F1D  |;
          ...
          CODE_9B8D11:
                       ...
                       CMP.W EdLnSelPlyIndx                 ;9B8D16|CD8F1D  |;
                       BNE CODE_9B8D20                      ;9B8D19|D005    |;
                       DEC.B $95                            ;9B8D1B|C695    |;
                       JSR.W CODE_9B8D32                    ;9B8D1D|20328D  |;
 
          CODE_9B8D20:
                       LDA.B $A5                            ;9B8D20|A5A5    |;
                       CLC                                  ;9B8D22|18      |;
                       ADC.W EdLnAvlPlayersCount            ;9B8D23|6D9F1D  |;
                       SBC.W EdLnCurPositionIndex           ;9B8D26|ED8B1D  |;
                       STA.B $95                            ;9B8D29|8595    |;
                       LDA.W EdLnSelPlyIndx                 ;9B8D2B|AD8F1D  |;
                       JSR.W CODE_9B8D7C                    ;9B8D2E|207C8D  |;
                       RTS                                  ;9B8D31|60      |;
 
          CODE_9B8D32:
                       JSR.W CODE_9B8D72                    ;9B8D32|20728D  |; Returns the current centers index
                       ...
                       RTS                                  ;9B8D4C|60      |;
          CODE_9B8D4D:
                       LDA.B $A5                            ;9B8D4D|A5A5    |;
                       db $1A,$1A,$85,$95,$20,$72,$8D,$8D   ;9B8D4F|        |;
                       db $93,$1D,$E6,$95,$E6,$95,$20,$72   ;9B8D57|        |;
                       db $8D,$C6,$95,$C6,$95,$20,$7C,$8D   ;9B8D5F|        |;
                       db $E6,$95,$E6,$95,$AD,$93,$1D,$20   ;9B8D67|        |;
                       db $7C,$8D,$60                       ;9B8D6F|        |;
          ...
          CODE_9B8E5F:
                       ...
                       JSL.L fn_rtnEdtLinesStartIndx        ;9B8E6B|2220939B|;
                       LDA.B $95                            ;9B8E6F|A595    |;
                       CLC                                  ;9B8E71|18      |;
                       ADC.B $A5                            ;9B8E72|65A5    |;
                       CLC                                  ;9B8E74|18      |;
                       ADC.W EdLnAvlPlayersCount            ;9B8E75|6D9F1D  |;
                       SEC                                  ;9B8E78|38      |;
                       SBC.W EdLnCurPositionIndex           ;9B8E79|ED8B1D  |;
       ...
       UNREACH_9B8F5D:
          ...
          CODE_9B8F7B:
                       ...
                       LDA.W EdLnSelLineIndx                ;9B8FC4|AD430D  |;
       ...
       UNREACH_9B8FD5:
          ...
          CODE_9B9249:
                       ...
                       LDA.W EdLnSelLineIndx                ;9B9263|AD430D  |;
                       DEC A                                ;9B9266|3A      |;
                       ASL A                                ;9B9267|0A      |;
                       ASL A                                ;9B9268|0A      |;
                       ASL A                                ;9B9269|0A      |;
                       STA.B $A5                            ;9B926A|85A5    |;
                       LDY.B zpCurntTeamLoopVal             ;9B926C|A491    |;
...
fn_rtnEdtLinesStartIndx:
                       LDA.W #$0000                         ;9B9320|A90000  |;
                       STA.B $97                            ;9B9323|8597    |;
                       LDA.B zpCurntTeamLoopVal             ;9B9325|A591    |;
                       BEQ CODE_9B932E                      ;9B9327|F005    |; If Zero Skip to Home
                       LDA.W #$1D1C                         ;9B9329|A91C1D  |; Away Team Line 1 Starting Index
                       BRA CODE_9B9331                      ;9B932C|8003    |;
 
          CODE_9B932E:
                       LDA.W #$1CE4                         ;9B932E|A9E41C  |; Home Team Line 1 Starting Index
          ...
          CODE_9B9334:
                       ...
                       PHA                                  ;9B9342|48      |;
                       PHY                                  ;9B9343|5A      |;
                       JSL.L fn_rtnEdtLinesStartIndx        ;9B9344|2220939B|;
                       LDY.B zpCurntTeamLoopVal             ;9B9348|A491    |;
          ...
          CODE_9B9361:
                       ...
                       JSL.L fn_rtnEdtLinesStartIndx        ;9B937D|2220939B|;
                       LDY.B zpCurntTeamLoopVal             ;9B9381|A491    |;
          ...
          CODE_9B939A:
                       ...
                       STA.B [$95]                          ;9B939E|8795    |; Save Away Team Best Line Extra Attacker into $1D22
                       REP #$20                             ;9B93A0|C220    |;
       ...
       UNREACH_9BB493:
          ...
          CODE_9BC6D5:
                       ...
                       PHA                                  ;9BC6EC|48      |;
                       LDA.B zpCurntTeamLoopVal             ;9BC6ED|A591    |;
                       PHA                                  ;9BC6EF|48      |;
                       ...
                       STA.B zpCurntTeamLoopVal             ;9BC6FB|8591    |;
          ...
          CODE_9BC71F:
                       ...
                       TAY                                  ;9BC726|A8      |;
                       LDA.B [zpCurntTeamLoopVal],Y         ;9BC727|B791    |;
                       ...
                       PLA                                  ;9BC742|68      |;
                       STA.B zpCurntTeamLoopVal             ;9BC743|8591    |;
                       PLA                                  ;9BC745|68      |;
