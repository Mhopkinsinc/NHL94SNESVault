...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if !PatchROM == 1 && !PlayerStat_BodyChecks == 1  ;If PatchROM is enabled and PlayerStat_BodyChecks is enabled then add new code 
         ...
         .recordChkF:                       
                       TAX                                  ;9EFBE3|AA      |;
                       SEP #$20                             ;9EFBE4|E220    |;
                       INC.W $168E,X                        ;9EFBE6|FE5016  |; Add 1 to the existing checks For value
                       REP #$20                             ;9EFBE9|C220    |;
         ...
         .recordChkA:                       
                       TAX                                  ;9EFBFB|AA      |;
                       SEP #$20                             ;9EFBFC|E220    |;
                       INC.W $16C2,X                        ;9EFBFE|FE8416  |; Add 1 to the existing checks Against value
                       REP #$20                             ;9EFC01|C220    |;
      ...
      if !PlayerStat_BodyChecks_Display == 1          ;Display Body Checks For in Player Stats UI
                        ...
                        LDA.W $168E,X           ;9C8A60|BD8A19  |; Load Checks For per player
